    ...
    while user_input_valid:
        ...
        if user_input in ("E", "e", "M", "m", "H", "h"):
            if user_input == 'E' or user_input == 'e':
                ...
                return hidden_word and print("Your word is ", len(hidden_word) ," letters.") 
...
def guess_word(word, guesses):
    ...
    for letter in word:
        if letter in guesses:
            mystery_word.append(letter).upper()
        else: 
